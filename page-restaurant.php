<?php session_start();
	if(!($_SESSION["is_auth"])){
		...
		$site = $rest->pageRest($_SERVER['REQUEST_URI']);
		$cat = $rest->catReq($_SERVER['REQUEST_URI']);
	}
                    ...
                    <div class="card social">
                        <div class="profile-header d-flex justify-content-between justify-content-center">
                            <div class="d-flex">
                            	<?php
                                echo "<div class=\"mr-3\">
                                    <img src=\"". $site["image"]."\" class=\"rounded\" alt=\"". $site["name"]."\">
                                </div>
                                <div class=\"details\">
                                    <h5 class=\"mb-0\">". $site["name"]."</h5>
                                    <span class=\"text-light\">". $site["address"]."</span>
...
foreach ($cat as $key) {
	if($key["status"]){
		echo "
            	<div class=\"col-sm-12 col-md-6 col-lg-4 a\">
                	<div class=\"card product\">
                		<i class='icon-basket' align= \"center\"></i>
                		<div class=\"body\">
                			<div class=\"row\">
                				<div class=\"col-sm-6\">
                			...
                			<p class=\"desc text-muted\">".$key["description"]."</p>
                		</div>
                		<div class=\"img-wrapper\">
	                		<div class=\"prod-image\" style=\"background-image: url('./img/10.jpg');\"></div>
	                	</div>
            		</div>
            	</div>
";}else{
